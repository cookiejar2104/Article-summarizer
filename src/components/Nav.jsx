...
const Nav = () => {
  return (
    <nav className=' bg-red-400 p-4 sm:p-6  font-bold font-satoshi  text-white  flex justify-between shadow-md shadow-slate-400 '>
        ...
        <Link to='/'>
            ...
            <li className=' sm:text-[20px] mx-6 font-courgette pt-2'>Articles, made easy</li>
